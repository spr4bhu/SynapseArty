module ID_EX(
    ...
    input wire stall,               // bubble (insert NOP) on load-use / flush
    input wire hold,                // re-present outputs (back-pressure, e.g. mem read latency)
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            // Hold EX so the instruction behind a stalled load isn't lost.
