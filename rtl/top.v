...
module top #(
    parameter INIT_FILE = "",                 // program image (.hex) for synthesis
    parameter [15:0] UART_BAUD_DIV = 16'd434   // core_clock_Hz / 115200
) (
    input wire clk,
    input wire rst,
    ...
    wire cpu_fetch_hold;               // pipeline stall -> freeze synchronous fetch
